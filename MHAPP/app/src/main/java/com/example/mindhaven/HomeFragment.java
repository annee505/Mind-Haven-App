...
public class HomeFragment extends Fragment {
    ...
    private CardView cardMoodTracker, cardRecommendations, cardPracticalCourses, cardMeditation, cardEmergencyContact;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        cardMeditation.setOnClickListener(v -> openFragment(new TherapyFragment()));

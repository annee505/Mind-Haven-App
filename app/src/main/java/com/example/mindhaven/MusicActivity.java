...
public class MusicActivity extends AppCompatActivity implements RecommendationAdapter.OnFavoriteClickListener {
    ...
    /**
     * Get music recommendations based on selected moods
     */
    private void getMusicRecommendations() {
        ...
        recommendationService.getMusicRecommendations(selectedMoods, new RecommendationService.RecommendationCallback() {
            @Override
            ...
            public void onError(String errorMessage) {
                ...
                // Show error message
                Toast.makeText(MusicActivity.this, errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }

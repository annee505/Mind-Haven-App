...
public class MoodHistoryAdapter extends RecyclerView.Adapter<MoodHistoryAdapter.MoodViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MoodViewHolder holder, int position) {
        ...
        // Set activities - Add null check for activitiesChipGroup
        if (holder.activitiesChipGroup != null) {
    ...
    static class MoodViewHolder extends RecyclerView.ViewHolder {
        ...
        MoodViewHolder(View itemView) {
            ...
            // The activitiesChipGroup might not exist in the layout, so handle the null case
